...
#unet2 = UNet2DConditionModel.from_pretrained(unet_id, subfolder="unet", torch_dtype=torch.float16)
unet2 = UNet2DConditionModel.from_pretrained(unet_id, subfolder="unet")
